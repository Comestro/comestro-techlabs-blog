...
const Header = () => {
  return (
    <div className="flex flex-1 gap-3 lg:gap-6 px-20 bg-white lg:justify-evenly py-2 justify-start items-center shadow-md">
      ...
      <div className="flex gap-5 font-sans  lg:block font-semibold ">
        {/* ------------------------------------------------------------------ */}
        ...
        <button
          ...
          className="block hover:text-blue-500 text-purple-600 cursor-pointer px-5 py-2.5 text-center "
          type="button"
        >
            ...
            <div class="relative bg-white h-full rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="flex bg-white  h-96 ">
                <div className="flex flex-col border-r-1 items-center mt-7 h-full w-1/4">
                  <a
                    herf=""
                    className="text-white hover:text-gray-400 bg-blue-500  text-lg hover:bg-blue-200  w-full h-12 text-center"
                  >
                    Learning Paths
                  </a>
                  <a
                    href=""
                    className="text-gray-400  text-lg hover:bg-blue-200 w-full h-12 text-center"
                  >
                    Practices
                  </a>
                </div>
                ...
                <button
                  type="button"
                  class="text-black mt-8  bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
